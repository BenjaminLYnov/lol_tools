...
namespace Collision
{
	...
	// Cancel collision from foot
	void NotTriggerFoot(sf::Sprite &sprite1, sf::Sprite &sprite2);

	// Get the side by where sprite1 is in collison with sprite2
	bool OnCollisionBySide(std::string side, sf::Sprite &sprite1, sf::Sprite &sprite2);

	// Get the vector normal that permit cancel collision
